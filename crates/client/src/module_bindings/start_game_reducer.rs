...
pub trait start_game {
    ...
    /// /// Use [`start_game:start_game_then`] to run a callback after the reducer completes.
    fn start_game(&self, game_id: u64) -> __sdk::Result<()> {
        self.start_game_then(game_id, |_, _| {})
    }
